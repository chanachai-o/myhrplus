...
@Component({
  selector: 'app-workarea-location-form',
  standalone: true,
  imports: [
    CommonModule,
    ReactiveFormsModule,
  ...
  templateUrl: './workarea-location-form.component.html'
})
export class WorkareaLocationFormComponent implements OnChanges {
  @Input() isOpen = false;
  @Input() data: WorkareaLocation | null = null;
  @Output() close = new EventEmitter<void>();
  @Output() save = new EventEmitter<void>();

  private fb = inject(FormBuilder);
  private service = inject(WorkareaLocationService);
