...
@Component({
  ...
  selector: 'app-probation-evaluation-form-competency-final',
  templateUrl: './probation-evaluation-form-competency-final.component.html',
  styleUrls: ['./probation-evaluation-form-competency-final.component.scss']
})
export class ProbationEvaluationFormCompetencyFinalComponent implements OnInit {
  @Input() jobName = ""
  @Input() step: any
