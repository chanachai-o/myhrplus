...
@Component({
  ...
  selector: 'app-tau-cscwf009',
  templateUrl: './tau-cscwf009.component.html',
  styleUrls: ['./tau-cscwf009.component.scss']
})
export class TauCscwf009Component implements OnInit {
