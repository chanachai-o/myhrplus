...
@Component({
  ...
  selector: 'app-pwf017-recruit-detail',
  templateUrl: './pwf017-recruit-detail.component.html',
  styleUrls: ['./pwf017-recruit-detail.component.scss']
})
export class Pwf017RecruitDetailComponent implements OnInit {
  @Input() data: any;
