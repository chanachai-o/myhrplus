...
@Component({
  ...
  selector: 'app-pwf014-center-detail',
  templateUrl: './pwf014-center-detail.component.html',
  styleUrls: ['./pwf014-center-detail.component.scss']
})
export class Pwf014CenterDetailComponent implements OnInit {
  page = 0;
  pageSize = 10;
  collectionSize = 0;
  active = 1;
