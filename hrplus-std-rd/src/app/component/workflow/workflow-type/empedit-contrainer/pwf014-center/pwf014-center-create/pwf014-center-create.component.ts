...
import { Pwf014CenterDetailComponent } from '../pwf014-center-detail/pwf014-center-detail.component'
...
@Component({
  ...
  selector: 'app-pwf014-center-create',
  templateUrl: './pwf014-center-create.component.html',
  styleUrls: ['./pwf014-center-create.component.scss'],
  providers: [DecimalPipe]
})
export class Pwf014CenterCreateComponent implements OnInit {
  @Input() data: any;
  ...
  setScreenValue() {
    this.workflowService.getDetailByRunNo(this.runno!).subscribe(async (result) => {
      ...
      this.dynamicComponent = Pwf014CenterDetailComponent
