...
import { Pwf014DetailComponent } from '../pwf014-detail/pwf014-detail.component';
...
@Component({
  ...
  selector: 'app-pwf014-create',
  templateUrl: './pwf014-create.component.html',
  styleUrls: ['./pwf014-create.component.scss'],
  providers: [DecimalPipe],
})
export class Pwf014CreateComponent implements OnInit {
  @Input() data: any;
  ...
  getEmpService() {
    ...
    this.empService.getWorkInformation(this.token.employeeid).subscribe((result: any) => {
      this.working = result;
      this.cdr.markForCheck();
    })
    this.empService.getEmployeeProfile(this.token.employeeid).subscribe((result: any) => {
      this.profile = result;
      this.cdr.markForCheck();
    })
  }
  ...
  getEmployeeAllProfile() {
    this.workflowService.getEmployeeAllProfile(this.token.employeeid).then(result => {
      this.emp = result
  ...
  setScreenValue() {
    this.workflowService.getDetailByRunNo(this.runno!).subscribe((result) => {
      ...
      this.dynamicComponent = Pwf014DetailComponent
  ...
  tab4check(No: number, no?: number) {
    ...
    if (No == 4 && no == 1) {
      ...
      if (this.fatherInsurance4.indexOf(".") == -1) {
        this.fatherInsurance4 = this._decimalPipe.transform(this.fatherInsurance4, "1.2-2")!;
      }
      else {
        this.fatherInsurance4 = this._decimalPipe.transform(this.fatherInsurance4, "1.2-2")!;
      }
    ...
    if (No == 4 && no == 2) {
      ...
      if (this.motherInsurance4.indexOf(".") == -1) {
        this.motherInsurance4 = this._decimalPipe.transform(this.motherInsurance4, "1.2-2")!;
      }
      else {
        this.motherInsurance4 = this._decimalPipe.transform(this.motherInsurance4, "1.2-2")!;
      }
    ...
    if (No == 4 && no == 3) {
      ...
      if (this.fatherSpouseInsurance4.indexOf(".") == -1) {
        this.fatherSpouseInsurance4 = this._decimalPipe.transform(this.fatherSpouseInsurance4, "1.2-2")!;
      }
      else {
        this.fatherSpouseInsurance4 = this._decimalPipe.transform(this.fatherSpouseInsurance4, "1.2-2")!;
      }
    ...
    if (No == 4 && no == 4) {
      ...
      if (this.motherSpouseInsurance4.indexOf(".") == -1) {
        this.motherSpouseInsurance4 = this._decimalPipe.transform(this.motherSpouseInsurance4, "1.2-2")!;
      }
      else {
        this.motherSpouseInsurance4 = this._decimalPipe.transform(this.motherSpouseInsurance4, "1.2-2")!;
      }
  ...
  tab4ToMoney(item: string): string {
    return this._decimalPipe.transform(item, "1.2-2") ? this._decimalPipe.transform(item, "1.2-2")! : "";
  }
