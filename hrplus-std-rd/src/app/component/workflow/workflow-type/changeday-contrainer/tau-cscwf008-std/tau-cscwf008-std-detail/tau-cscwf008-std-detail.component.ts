...
@Component({
  ...
  selector: 'app-tau-cscwf008-std-detail',
  templateUrl: './tau-cscwf008-std-detail.component.html',
  styleUrls: ['./tau-cscwf008-std-detail.component.scss']
})
export class TAUCSCWF008STDDetailComponent implements OnInit {
  @Input() data: any;
