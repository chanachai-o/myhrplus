...
@Component({
  ...
  selector: 'app-tau-cscwf008-hr-detail',
  templateUrl: './tau-cscwf008-hr-detail.component.html',
  styleUrls: ['./tau-cscwf008-hr-detail.component.scss']
})
export class TAUCSCWF008HrDetailComponent implements OnInit {
  @Input() data: any;
