...
@Component({
  ...
  selector: 'app-tau-cscwf008-center-detail',
  templateUrl: './tau-cscwf008-center-detail.component.html',
  styleUrls: ['./tau-cscwf008-center-detail.component.scss']
})
export class TAUCSCWF008CenterDetailComponent implements OnInit {
  @Input() data: any;
