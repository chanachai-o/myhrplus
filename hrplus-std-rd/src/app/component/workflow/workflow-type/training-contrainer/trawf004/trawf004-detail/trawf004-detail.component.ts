...
@Component({
  ...
  templateUrl: './trawf004-detail.component.html',
  styleUrls: ['./trawf004-detail.component.scss']
})
export class Trawf004DetailComponent implements OnInit {
