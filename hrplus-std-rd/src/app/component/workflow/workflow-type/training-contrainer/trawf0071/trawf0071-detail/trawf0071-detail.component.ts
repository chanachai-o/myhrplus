...
@Component({
  ...
  templateUrl: './trawf0071-detail.component.html',
  styleUrls: ['./trawf0071-detail.component.scss']
})
export class Trawf0071DetailComponent implements OnInit {
  @Input() data: any;
