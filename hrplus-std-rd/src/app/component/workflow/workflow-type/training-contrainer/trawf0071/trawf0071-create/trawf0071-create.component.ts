...
import { Trawf0071DetailComponent } from '../trawf0071-detail/trawf0071-detail.component';
...
@Component({
  selector: 'app-trawf0071-create',
  templateUrl: './trawf0071-create.component.html',
  styleUrls: ['./trawf0071-create.component.scss'],
  standalone: true,
  imports: [
    CommonModule,
    FormsModule,
...
export class Trawf0071CreateComponent implements OnInit {
  @Input() data: any;
  employeeCCId = ""
  ...
  setScreenValue() {
    this.workflowService.getDetailByRunNo(this.runno!).subscribe((result) => {
      ...
      this.dynamicComponent = Trawf0071DetailComponent
