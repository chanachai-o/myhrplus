...
import { Trawf009DetailComponent } from '../trawf009-detail/trawf009-detail.component';
...
@Component({
  selector: 'app-trawf009-create',
  templateUrl: './trawf009-create.component.html',
  styleUrls: ['./trawf009-create.component.scss'],
  standalone: true,
  imports: [
    CommonModule,
    FormsModule,
...
export class Trawf009CreateComponent implements OnInit {
  ...
  setScreenValue() {
    this.workflowService.getDetailByRunNo(this.runno!).subscribe((result) => {
      ...
      this.dynamicComponent = Trawf009DetailComponent
