...
@Component({
  ...
  templateUrl: './trawf009-detail.component.html',
  styleUrls: ['./trawf009-detail.component.scss']
})
export class Trawf009DetailComponent implements OnInit {
  @Input() data: any;
