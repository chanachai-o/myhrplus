...
@Component({
  ...
  templateUrl: './trawf007-detail.component.html',
  styleUrls: ['./trawf007-detail.component.scss']
})
export class Trawf007DetailComponent implements OnInit {
