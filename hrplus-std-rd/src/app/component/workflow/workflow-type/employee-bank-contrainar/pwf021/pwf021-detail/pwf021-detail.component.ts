...
@Component({
  ...
  selector: 'app-pwf021-detail',
  templateUrl: './pwf021-detail.component.html',
  styleUrls: ['./pwf021-detail.component.scss']
})
export class Pwf021DetailComponent implements OnInit {
  @Input() data: any;
