...
@Component({
  ...
  selector: 'app-tau-cscwf021-sup-detail',
  templateUrl: './tau-cscwf021-sup-detail.component.html',
  styleUrls: ['./tau-cscwf021-sup-detail.component.scss']
})
export class TAUCSCWF021SupDetailComponent implements OnInit {
  wfid = "8121"
  workflowData: any
  manageDocument: any
  employeeId = ""
