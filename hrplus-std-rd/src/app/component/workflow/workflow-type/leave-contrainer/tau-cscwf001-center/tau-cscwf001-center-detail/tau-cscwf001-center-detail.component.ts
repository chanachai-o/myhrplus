...
@Component({
  ...
  selector: 'app-tau-cscwf001-center-detail',
  templateUrl: './tau-cscwf001-center-detail.component.html',
  styleUrls: ['./tau-cscwf001-center-detail.component.scss']
})
export class TauCscwf001CenterDetailComponent implements OnInit {
  @Input() data: any;
