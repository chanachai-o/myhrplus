...
@Component({
  ...
  selector: 'app-tau-cscwf001',
  templateUrl: './tau-cscwf001.component.html',
  styleUrls: ['./tau-cscwf001.component.scss']
})
export class TauCscwf001Component implements OnInit {
