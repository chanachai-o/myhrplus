...
@Component({
  ...
  selector: 'app-tau-cscwf006-detail',
  templateUrl: './tau-cscwf006-detail.component.html',
  styleUrls: ['./tau-cscwf006-detail.component.scss']
})
export class TAUCSCWF006DetailComponent implements OnInit {
  page = 0;
  pageSize = 10;
  collectionSize = 0;
