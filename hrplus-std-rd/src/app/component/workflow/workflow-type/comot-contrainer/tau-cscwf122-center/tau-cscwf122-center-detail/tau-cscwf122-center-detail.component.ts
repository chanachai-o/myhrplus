...
@Component({
  ...
  selector: 'app-tau-cscwf122-center-detail',
  templateUrl: './tau-cscwf122-center-detail.component.html',
  styleUrls: ['./tau-cscwf122-center-detail.component.scss']
})
export class TAUCSCWF122CenterDetailComponent implements OnInit {
  page = 0;
  pageSize = 10;
  collectionSize = 0;
