...
@Component({
  ...
  selector: 'app-tau-cscwf122-center',
  templateUrl: './tau-cscwf122-center.component.html',
  styleUrls: ['./tau-cscwf122-center.component.scss']
})
export class TAUCSCWF122CenterComponent implements OnInit {
