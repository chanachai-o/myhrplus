...
@Component({
  ...
  selector: 'app-wf2559-center-detail',
  templateUrl: './wf2559-center-detail.component.html',
  styleUrls: ['./wf2559-center-detail.component.scss']
})
export class Wf2559CenterDetailComponent implements OnInit {
  @Input() data: any
    ...
    if (changes) {
      if (this.data.workflowData.reference.length > 0) {
        this.workflowService.getDetailByDocNo(this.data.workflowData.reference[0].docNo!).then(result => {
          ...
          this.dynamicComponent2 = Wf2559CenterDetailComponent
