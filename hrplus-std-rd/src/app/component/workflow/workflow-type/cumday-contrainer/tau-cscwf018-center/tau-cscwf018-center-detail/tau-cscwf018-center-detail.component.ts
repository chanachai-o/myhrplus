...
@Component({
  ...
  selector: 'app-tau-cscwf018-center-detail',
  templateUrl: './tau-cscwf018-center-detail.component.html',
  styleUrls: ['./tau-cscwf018-center-detail.component.scss']
})
export class TAUCSCWF018CenterDetailComponent implements OnInit {
  @Input() data: any;
