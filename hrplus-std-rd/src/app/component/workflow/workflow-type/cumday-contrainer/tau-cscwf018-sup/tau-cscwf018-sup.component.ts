...
@Component({
  ...
  selector: 'app-tau-cscwf018-sup',
  templateUrl: './tau-cscwf018-sup.component.html',
  styleUrls: ['./tau-cscwf018-sup.component.scss']
})
export class TAUCSCWF018SupComponent implements OnInit {
