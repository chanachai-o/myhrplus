...
@Component({
  ...
  selector: 'app-tau-cscwf018',
  templateUrl: './tau-cscwf018.component.html',
  styleUrls: ['./tau-cscwf018.component.scss']
})
export class TAUCSCWF018Component implements OnInit {
