...
@Component({
  ...
  selector: 'app-tau-cscwf018-detail',
  templateUrl: './tau-cscwf018-detail.component.html',
  styleUrls: ['./tau-cscwf018-detail.component.scss']
})
export class TAUCSCWF018DetailComponent implements OnInit {
  @Input() data: any;
