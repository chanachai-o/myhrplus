...
import { Pwf001newDetailComponent } from '../pwf001new-detail/pwf001new-detail.component';
...
@Component({
  ...
  selector: 'app-pwf001new-create',
  templateUrl: './pwf001new-create.component.html',
  styleUrls: ['./pwf001new-create.component.scss']
})
export class Pwf001newCreateComponent implements OnInit {
  @Input() data: any;
  employeeCCId = ""
  wfid = "2001"
  cardNameTh = ""
  ...
  setScreenValue() {
    this.wfService.getDetailByRunNo(this.runno!).subscribe(result => {
      ...
      this.dynamicComponent = Pwf001newDetailComponent
  ...
  getWorkflowId() {
    this.activatedRoute.paramMap.subscribe(result => {
      ...
      this.cardNameTh = sessionStorage.getItem("2001_newThName") ? sessionStorage.getItem("2001_newThName")! : ""
      this.cardNameEng = sessionStorage.getItem("2001_newEngName") ? sessionStorage.getItem("2001_newEngName")! : ""
      this.cdr.markForCheck()
    })
  }
