...
@Component({
  ...
  selector: 'app-pwf001new-boss-detail',
  templateUrl: './pwf001new-boss-detail.component.html',
  styleUrls: ['./pwf001new-boss-detail.component.scss']
})
export class Pwf001newBossDetailComponent implements OnInit {
