...
@Component({
  ...
  selector: 'app-tau-cscwf007-center-detail',
  templateUrl: './tau-cscwf007-center-detail.component.html',
  styleUrls: ['./tau-cscwf007-center-detail.component.scss']
})
export class TAUCSCWF007CenterDetailComponent implements OnInit {
  @Input() data: any;
