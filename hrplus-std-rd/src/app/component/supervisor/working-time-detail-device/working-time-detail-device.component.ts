...
import { NgbModal, NgbPaginationModule, NgbTypeahead, NgbTypeaheadModule } from '@ng-bootstrap/ng-bootstrap';
...
@Component({
  standalone: true,
  imports: [CommonModule, TranslateModule, NgbTypeaheadModule, NgbPaginationModule, FormsModule],
  selector: 'app-working-time-detail-device',
  templateUrl: './working-time-detail-device.component.html',
  styleUrls: ['./working-time-detail-device.component.scss']
})
export class WorkingTimeDetailDeviceComponent implements OnInit {
  closeResult = '';
  page = 1;
  pageSize = 50;
