...
@Component({
  selector: "app-orgchartNew",
  templateUrl: "./orgchartNew.component.html",
  styleUrls: ["./orgchartNew.component.scss"],
  encapsulation: ViewEncapsulation.None
})
export class OrgchartNewComponent implements OnInit {
    ...
    initChart() {
        ...
        OrgChart.templates.myTemplate.node = `<rect x="0" y="0" height="{h}" width="{w}" fill="#FFFFFF" stroke-width="2" stroke="#154C9C" rx="12" ry="12"></rect>
        ...
        OrgChart.templates.myTemplate.field_1 = `<text data-width="250" class="field_1" style="font-size: 16px; font-weight: bold;" fill="#154C9C" x="105" y="50" text-anchor="start">{val}</text>`;
        OrgChart.templates.myTemplate.field_2 = `<text data-width="250" class="field_2" style="font-size: 14px;" fill="#154C9C" x="105" y="70" text-anchor="start">{val}</text>`;
        OrgChart.templates.myTemplate.field_3 = `<text data-width="250" class="field_3" style="font-size: 10px;" fill="#444444" x="20" y="20" text-anchor="start">รหัสพนักงาน:{val}</text>`;
        OrgChart.templates.myTemplate.field_4 = `<text data-width="250" class="field_4" style="font-size: 12px;" fill="#444444" x="105" y="95" text-anchor="start">{val}</text>`;
        OrgChart.templates.myTemplate.img_0 = `<clipPath id="ulaImg"><circle cx="53" cy="70" r="45"></circle></clipPath>
            <image preserveAspectRatio="xMidYMid slice" clip-path="url(#ulaImg)" xlink:href="{val}" x="8" y="25" width="90" height="90"></image>`;
        OrgChart.templates.myTemplate.plus = `<circle cx="14" cy="16" r="13" stroke-width="1" fill="#595BEA" stroke="#595BEA"></circle>
        ...
        OrgChart.templates.myTemplate.minus = `<circle cx="15" cy="15" r="12" fill="#f0e2ea" stroke="#f0e2ea" stroke-width="1"></circle>
                          <line x1="10" y1="15" x2="20" y2="15" stroke-width="2" stroke="#595BEA"></line>`;
        OrgChart.templates.myTemplate.link = `<path stroke-linejoin="round" stroke="#eeeeee" stroke-width="2" fill="none" d="{edge}" />`;
        OrgChart.templates.myTemplate.nodeMenuButton = `<g style="cursor:pointer;" transform="matrix(1,0,0,1,275,40)" data-ctrl-n-menu-id="{id}">
          ...
          OrgChart.templates.empList1 = createTemplate(OrgChart.templates.myTemplate, "#446AC5");
          OrgChart.templates.empList2 = createTemplate(OrgChart.templates.myTemplate, "#E93C8D");
          OrgChart.templates.empList3 = createTemplate(OrgChart.templates.myTemplate, "#F9782E");
          OrgChart.templates.empList4 = createTemplate(OrgChart.templates.myTemplate, "#E7A927");
          OrgChart.templates.empList5 = createTemplate(OrgChart.templates.myTemplate, "#1DBE5A");
          OrgChart.templates.empList6 = createTemplate(OrgChart.templates.myTemplate, "#569BF5");
          OrgChart.templates.empList7 = createTemplate(OrgChart.templates.myTemplate, "#9AC5FD");

        this.chart = new OrgChart(document.getElementById("tree2")!, {
            ...
            tags: {
                empList1: { template: "empList1" },
                empList2: { template: "empList2" },
                empList3: { template: "empList3" },
                empList4: { template: "empList4" },
                empList5: { template: "empList5" },
                empList6: { template: "empList6" },
                empList7: { template: "empList7" }
            },
            nodeMenu: {
                details: {
                ...
                //     onClick: (nodeId: string) => {
                //         const node = this.chartList.find((n: any) => n.id === nodeId); // ค้นหาโหนด
                //         const tagMap = ["bu2", "bu3", "bu4", "group", "empList",];
            ...
            enableDragDrop: true,
            nodeMouseClick: OrgChart.action.ctrlZoom,
        });
        ...
        this.loadDatasource()
            .pipe(
                ...
                map((m: any) => {
                    ...
                    // const tags = m.plId === 1 ? ["empList"] : m.plId === 2 ? ["empList2"] : [];
    ...
    loadDatasource(): Observable<any[]> {
        return this.org.getEmpWork2().pipe(
            switchMap((res: any) => {
                // console.log("res", res);
                const req$ = Array.apply(null, Array(res["totalPages"])).map(
                    (e, index) => { return this.org.getEmpWork2(); });
                // console.log("req$", req$);
