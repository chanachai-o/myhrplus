...
import {
  ...
  @Component({
    ...
    selector: 'app-orgchartSale',
    templateUrl: './orgchartSale.component.html',
    styleUrls: ['./orgchartSale.component.scss'],
    encapsulation: ViewEncapsulation.None,
  })
  export class OrgchartSaleComponent implements OnInit {

  @ViewChild("addNodeModal") addNodeModal: any; // อ้างอิงถึง modal
      @ViewChild("addEmpModal2") addEmpModal2: any;
      ...
      newNode: {
          ...
          emp?: {
              ...
              efname: string,
              elname: string,
              company: { companyid: string, tdesc: string, edesc: string, img: string, parent: string },
      ...
      companyList: { companyid: string, tdesc: string, edesc: string, img: string, parent: string }[] = []
      ...
      initChart() {
          ...
          // bu1
          OrgChart.templates.bu1 = Object.assign({},OrgChart.templates.myTemplate);
          OrgChart.templates.bu1.node = `<rect x="0" y="0" height="{h}" width="{w}" fill="#ffffff" stroke-width="2" stroke="#eeeeee"></rect>
              <line x1="0" y1="2.5" x2="230" y2="2.5" stroke-width="5" stroke="#595BEA"></line>`;
          OrgChart.templates.bu1.field_0 = `<text width="180" text-overflow="multiline" style="font-size: 16px;" font-weight="bold" fill="#636363" x="15" y="49" text-anchor="start">{val}</text>`;
          OrgChart.templates.bu1.field_1 = `<text width="210" text-overflow="multiline" style="font-size: 10px;" font-weight="bold" fill="#aeaeae" x="15" y="30" text-anchor="start">{val}</text>`;
          OrgChart.templates.bu1.field_2 = `<text width="210" text-overflow="multiline" style="font-size: 10px;" font-weight="bold" fill="#aeaeae" x="15" y="68" text-anchor="start">รหัส:{val}</text>`;

          OrgChart.templates.bu1.plus = `<circle cx="14" cy="16" r="13" stroke-width="1" fill="#595BEA" stroke="#595BEA"></circle>
              <text text-anchor="middle" style="font-size: 10px;cursor:pointer;" font-weight="bold" fill="#ffffff" x="14" y="20">{collapsed-children-count}</text>`;
          OrgChart.templates.bu1.minus = `<circle cx="15" cy="15" r="12" fill="#f0e2ea" stroke="#f0e2ea" stroke-width="1"></circle>
          ...
          OrgChart.templates.bu2.field_2 = `<text width="210" text-overflow="multiline" style="font-size: 10px;" font-weight="bold" fill="#aeaeae" x="15" y="68" text-anchor="start">รหัส:{val}</text>`;

          OrgChart.templates.bu2.plus = `<circle cx="14" cy="16" r="13" stroke-width="1" fill="#9F49F1" stroke="#9F49F1"></circle>
              <text text-anchor="middle" style="font-size: 10px;cursor:pointer;" font-weight="bold" fill="#ffffff" x="14" y="20">{collapsed-children-count}</text>`;
          ...
          OrgChart.templates.bu3.field_2 = `<text width="210" text-overflow="multiline" style="font-size: 10px;" font-weight="bold" fill="#aeaeae" x="15" y="68" text-anchor="start">รหัส:{val}</text>`;

          OrgChart.templates.bu3.plus = `<circle cx="14" cy="16" r="13" stroke-width="1" fill="#FF68AE" stroke="#FF68AE"></circle>
              <text text-anchor="middle" style="font-size: 10px;cursor:pointer;" font-weight="bold" fill="#ffffff" x="14" y="20">{collapsed-children-count}</text>`;
          ...
          OrgChart.templates.bu4.node = `<rect x="0" y="0" height="{h}" width="{w}" fill="#ffffff" stroke-width="2" stroke="#eeeeee"></rect>
              <line x1="0" y1="2.5" x2="230" y2="2.5" stroke-width="5" stroke="#F9782E"></line>`;
          ...
          OrgChart.templates.bu4.field_2 = `<text width="210" text-overflow="multiline" style="font-size: 10px;" font-weight="bold" fill="#aeaeae" x="15" y="68" text-anchor="start">รหัส:{val}</text>`;

          OrgChart.templates.bu4.plus = `<circle cx="14" cy="16" r="13" stroke-width="1" fill="#F9782E" stroke="#F9782E"></circle>
              <text text-anchor="middle" style="font-size: 10px;cursor:pointer;" font-weight="bold" fill="#ffffff" x="14" y="20">{collapsed-children-count}</text>`;
          OrgChart.templates.bu4.minus = `<circle cx="15" cy="15" r="12" fill="#f0e2ea" stroke="#f0e2ea" stroke-width="1"></circle>
              <line x1="10" y1="15" x2="20" y2="15" stroke-width="2" stroke="#F9782E"></line>`;
          ...
          OrgChart.templates.group.field_0 =  OrgChart.templates.group.field_0.replace(/fill="[^"]+"/g, 'fill="#444444"');
      ...
      style="font-size: 14px;" fill="#ff0000" x="125" y="15" text-anchor="middle">
      {val}</text>`;
          // กลุ่ม

          // พนักงาน
          OrgChart.templates.empList = Object.assign({}, OrgChart.templates.olivia);
          OrgChart.templates.empList.size = [300, 120];
          OrgChart.templates.empList.node = `<rect x="0" y="0" height="{h}" width="{w}" fill="#FFFFFF" stroke-width="1" stroke="#446AC5" rx="12" ry="12"></rect>
          ...
          OrgChart.templates.empList.field_2 = `<text data-width="250" class="field_2" style="font-size: 10px;" fill="#444444" x="20" y="20" text-anchor="start">รหัสพนักงาน:{val}</text>`;
          OrgChart.templates.empList.field_3 = `<text data-width="250" class="field_3" style="font-size: 16px; font-weight: bold;" fill="#154C9C" x="105" y="50" text-anchor="start">{val}</text>`;
          OrgChart.templates.empList.field_4 = `<text data-width="250" class="field_4" style="font-size: 14px;" fill="#154C9C" x="105" y="70" text-anchor="start">{val}</text>`;
          OrgChart.templates.empList.field_5 = `<text data-width="250" class="field_5" style="font-size: 12px;" fill="#444444" x="105" y="95" text-anchor="start">{val}</text>`;
          OrgChart.templates.empList.img_0 = `<clipPath id="ulaImg"><circle cx="53" cy="70" r="45"></circle></clipPath>
              <image preserveAspectRatio="xMidYMid slice" clip-path="url(#ulaImg)" xlink:href="{val}" x="8" y="25" width="90" height="90"></image>`;
          OrgChart.templates.empList.plus = `<circle cx="14" cy="16" r="13" stroke-width="1" fill="#595BEA" stroke="#595BEA"></circle>
              <text text-anchor="middle" style="font-size: 10px;cursor:pointer;" font-weight="bold" fill="#ffffff" x="14" y="20">{collapsed-children-count}</text>`;

          OrgChart.templates.empList.minus = `<circle cx="15" cy="15" r="12" fill="#f0e2ea" stroke="#f0e2ea" stroke-width="1"></circle>
              <line x1="10" y1="15" x2="20" y2="15" stroke-width="2" stroke="#595BEA"></line>`;
          OrgChart.templates.empList.link = `<path stroke-linejoin="round" stroke="#eeeeee" stroke-width="2" fill="none" d="{edge}" />`;
          OrgChart.templates.empList.nodeMenuButton = `<g style="cursor:pointer;" transform="matrix(1,0,0,1,275,40)" data-ctrl-n-menu-id="{id}">
                 <rect x="-4" y="-10" fill="#000000" fill-opacity="0" width="22" height="22"></rect>
          ...
          OrgChart.templates.company.size = [360, 120];
          OrgChart.templates.company.node = `<rect x="0" y="0" height="120" width="360" fill="#FFFFFF" stroke-width="1" stroke="#aeaeae" rx="12" ry="12"></rect>`;
          OrgChart.templates.company.field_0 = `<text data-width="250" class="field_0" style="font-size: 18px; font-weight: bold;" fill="#444444" x="115" y="55" text-anchor="start">{val}</text>`;
          OrgChart.templates.company.field_1 = `<text data-width="250" class="field_1" style="font-size: 14px;" fill="#000000" x="115" y="75" text-anchor="start">{val}</text>`;
          OrgChart.templates.company.nodeMenuButton = `<g style="cursor:pointer;" transform="matrix(1,0,0,1,330,40)" data-ctrl-n-menu-id="{id}">
         <rect x="-4" y="-10" fill="#000000" fill-opacity="0" width="22" height="22"></rect>
         <circle cx="15" cy="10" r="3" fill="#939598"></circle>
         <circle cx="15" cy="18" r="3" fill="#939598"></circle>
         <circle cx="15" cy="26" r="3" fill="#939598"></circle>
       </g>`;
          OrgChart.templates.company.plus = `<circle cx="14" cy="16" r="13" stroke-width="1" fill="#595BEA" stroke="#595BEA"></circle>
      <text text-anchor="middle" style="font-size: 10px;cursor:pointer;" font-weight="bold" fill="#ffffff" x="14" y="20">{collapsed-children-count}</text>`;

          OrgChart.templates.company.minus = `<circle cx="15" cy="15" r="12" fill="#f0e2ea" stroke="#f0e2ea" stroke-width="1"></circle>
      <line x1="10" y1="15" x2="20" y2="15" stroke-width="2" stroke="#595BEA"></line>`;
          OrgChart.templates.company.link = `<path stroke-linejoin="round" stroke="#eeeeee" stroke-width="2" fill="none" d="{edge}" />`;
          //
          this.chart = new OrgChart(document.getElementById("tree")!, {
              ...
              nodeMenu: {
                  ...
                  //     onClick: (nodeId: string) => {
                  //         const node = this.chartList.find((n: any) => n.id === nodeId); // ค้นหาโหนด
                  //         const tagMap = ["bu1", "bu2", "bu3", "bu4", ["bu5", "group"], "empList",];
                  //         if (node && node.level >= 1 && node.level <= tagMap.length) {
                  //             const newNode = {
          ...
          this.chart.on("drop", function (sender: any, draggedNodeId: any, droppedNodeId: any) {
      ...
      hasChildren(node: any): boolean {
          return this.chartList.some((n: any) => n.pid === node.id);
      }
      ...
      addNode(newNode: any) {
          ...
          // เพิ่ม node ลงใน orgChart โดยไม่ต้องรีโหลด
      ...
      addNewEmp(newEmp: any) {
          ...
          const newEmpNode = {
              id: newEmp.id,
              // pid: "", // หากต้องการเพิ่ม `pid` สามารถใส่ที่นี่
          ...
          console.log("eiei newEmpNode:", newEmpNode);
      }
      ...
      updateNode() {
          if (this.selectedNode) {
              ...
              modalRef.result.then((response) => {
                  if (response) {
                      this.chart.updateNode(this.selectedNode); // อัพเดท Node ในแผนผัง
      ...
      getListBuAll() {
        forkJoin({
            getCompanySale: this.org.getCompanySale(),
            // getBu1Sale: this.org.getBu1Sale(),
        }).subscribe(async (response) => {
            const processBu = async (buData: any, tag: any, level: any) => {
                const result = await Promise.all(
                    buData.map(async (m: any) => {
                        const base64Image = m.img ? await this.convertImageToBase64(m.img) : "";
                        return {
                            id: m[`${tag}Id`],
                            ...
                            edesc: m.edesc,
                            tags: [tag],
                            img: base64Image, // แปลงรูปภาพเป็น Base64
                            level: level
                        };
                    })
                );
            ...
            this.chartList = [
                ...(await processBu(response.getCompanySale, "company", 0)),
                // ...(await processBu(response.getBu5Sale, "bu5", 5).map((item: any) => ({ ...item, tags: [...item.tags, "group"], }))),
            ];

            this.companyList = response.getCompanySale;
            // this.bu1List = response.getBu1Sale
            this.getEmpData();
        });
    }
      ...
      getEmpData() {
        this.loadDatasource()
            .pipe(
                ...
                switchMap((arr) => from(arr)), // ใช้ `from` เพื่อแปลง array เป็น observable ทีละตัว
                mergeMap(async (m: any) => {
                    const boss = m.bossId != null && m.bossId != m.employeeId ? m.bossId : "NONE";
                    const base64Image = m.picture ? await this.convertImageToBase64(m.picture) : "";

                    return {
                        id: m.employeeId,
                        pid: boss,
                        name: m.fname + " " + m.lname,
                        nameEng: m.efname + " " + m.elname,
                        position: m.position,
                        img: base64Image, // แทนที่รูปภาพด้วย Base64
                        company: m.company?.tdesc,
                        bu1: m.bu1?.tdesc,
                        bu2: m.bu2?.tdesc,
                        bu3: m.bu3?.tdesc,
                        bu4: m.bu4?.tdesc,
      ...
      loadDatasource(): Observable<any[]> {
          return this.org.getEmpWorkSale().pipe(
              switchMap((res: any) => {
                  console.log("res", res);
                  const req$ = Array.apply(null, Array(res["totalPages"])).map(
                      (e, index) => { return this.org.getEmpWorkSale(); });
                  console.log("req$", req$);
