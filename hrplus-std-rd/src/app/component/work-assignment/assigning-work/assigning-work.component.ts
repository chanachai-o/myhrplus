...
@Component({
  ...
  selector: 'app-assigning-work',
  templateUrl: './assigning-work.component.html',
  styleUrls: ['./assigning-work.component.scss'],
  encapsulation: ViewEncapsulation.None
})
export class AssigningWorkComponent implements OnInit {
