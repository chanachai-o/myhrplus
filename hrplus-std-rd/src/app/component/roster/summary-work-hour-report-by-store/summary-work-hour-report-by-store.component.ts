...
@Component({
  ...
  imports: [CommonModule, TranslateModule, FormsModule, ScrollingModule, NgbPaginationModule],
    selector: 'app-summary-work-hour-report-by-store',
    templateUrl: './summary-work-hour-report-by-store.component.html',
    styleUrls: ['./summary-work-hour-report-by-store.component.scss']
  })
  export class SummaryWorkHourReportByStoreComponent implements OnInit {
  monthList = [
