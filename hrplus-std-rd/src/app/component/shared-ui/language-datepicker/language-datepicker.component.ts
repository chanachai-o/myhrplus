...
import { NgbDateStruct, NgbDatepickerI18n, NgbDatepickerModule } from '@ng-bootstrap/ng-bootstrap';
...
export class CustomDatepickerI18n extends NgbDatepickerI18n {
  ...
  getWeekdayLabel(weekday: number): string {
    return ''; // Added to implement inherited abstract member 'getWeekdayLabel'
  }
}
// last
