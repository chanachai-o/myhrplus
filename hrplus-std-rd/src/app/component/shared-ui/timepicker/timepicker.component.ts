...
import { UntypedFormControl, AbstractControl, FormsModule, ReactiveFormsModule } from '@angular/forms';
...
@Component({
  ...
  standalone: true,
  imports: [CommonModule, FormsModule, ReactiveFormsModule, NgbTimepickerModule]
})
