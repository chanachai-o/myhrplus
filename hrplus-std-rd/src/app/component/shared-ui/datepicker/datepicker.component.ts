...
import { NgbDateStruct, NgbCalendar, NgbDateAdapter, NgbDateNativeAdapter, NgbDate, NgbDatepickerModule } from '@ng-bootstrap/ng-bootstrap';
...
export class NgbdDatepickerBasicComponent {
  ...
  isHovered = (date: NgbDate) => this.fromDate
    && !this.toDate && this.hoveredDate && after(date, this.fromDate)
